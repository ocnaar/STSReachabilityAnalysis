...
function xdot = TVLQRSTS3LinkPvec(t,x,tgrid,xbar,ubar,Ktvmat,p)
...
% Reference state from cubic interpolation of the state trajectories.
xr = zeros(nx,1);
for i=1:nx
    xr(i) = csapi(tgrid,xbar(:,i),t);
end

% Reference input from cubic interpolation of the input trajectories.
ur = zeros(nu,1);
for i=1:nu
...
A = [[0;0;1],-ones(3,1),-[l1,l2,l3;0,l2,l3;0 0 l3]*sv,[l1,l2,l3;0,l2,l3;0 0 l3]*cv];
